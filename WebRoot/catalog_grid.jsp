<%@page import="com.dqz.entity.Piano"%>
<%@page import="com.dqz.entity.Product"%>
    ...
    <div class="container_12">
       <div id="sidebar" class="grid_3">
	      <aside id="categories_nav">
		     ...
		     <nav class="left_menu">
			    <ul>
				   <li><a href="#">钢琴 <span>(21)</span></a></li>
				   <li><a href="#">电钢琴<span> (27)</span></a></li>
				   <li><a href="#">吉他 <span>(33)</span></a></li>
				   <li><a href="#">尤克里里 <span>(17)</span></a></li>
				   <li><a href="#">小提琴 <span>(23)</span></a></li>
				   <li><a href="#">萨克斯 <span>(7)</span></a></li>
				   <li class="last"><a href="#">古筝 <span>(135)</span></a></li>
				    <li><a href="#">二胡 <span>(7)</span></a></li>
				     <li><a href="#">葫芦丝 <span>(7)</span></a></li>
				      <li><a href="#">架子鼓 <span>(7)</span></a></li>
				       <li><a href="#">口琴<span>(7)</span></a></li>
			    </ul>
		     </nav><!-- .left_menu -->
...
<% List<Product> turns=(List<Product>)request.getAttribute("list");
...
Product p=turns.get(i);
%>
 <div class="grid_3 product">
<div class="prev">
<a href="product_page.html"><img src="images/product_1.png" alt="" title="" /></a>
</div><!-- .prev -->
 <h3 class="title" title="<%=p.getPname()%>"><%=p.getPname().substring(0,15)%>...</h3>
<div class="cart">
<div class="price">
<div class="vert">
...
<%} 
  ...
  <footer>
    ...
    <div class="f_info">
      <div class="container_12">
        <div class="grid_6">
          <p class="copyright">© Breeze Store Theme, 2013. Collect from <a href="http://www.mycodes.net/" title="网页模板" target="_blank">网页模板</a></p>
        </div><!-- .grid_6 -->
